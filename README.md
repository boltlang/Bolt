...
> You're looking at the next generation of the Bolt compiler and programming
> language. This repository contains the working draft of the new compiler. The
> new language is severely different from the past versions and accumulates
> years of experience discovering and researching functional programming
> languages.

Bolt is a new strictly-evaluated functional programming language in the making that aims to
make writing complex applications dead-simple. It ships with some nice goodies,
including:
