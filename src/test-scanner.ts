...
`)
  ...
  t.assert(tokens[1].type === TokenType.Identifier);
  t.assert(tokens[2].type === TokenType.BlockStart);
  ...
  t.assert(tokens[7].type === TokenType.Identifier);
  t.assert(tokens[8].type === TokenType.LineFoldEnd);
  t.assert(tokens[9].type === TokenType.LineFoldStart);
  t.assert(tokens[10].type === TokenType.Identifier);
...
a.
  b.
    ...
    e
`)
  t.assert(tokens.length === 19);
  t.assert(tokens[0].type === TokenType.LineFoldStart);
  t.assert(tokens[1].type === TokenType.Identifier);
  t.assert(tokens[2].type === TokenType.BlockStart);
  t.assert(tokens[3].type === TokenType.LineFoldStart);
  t.assert(tokens[4].type === TokenType.Identifier);
  t.assert(tokens[5].type === TokenType.BlockStart);
  t.assert(tokens[6].type === TokenType.LineFoldStart);
  t.assert(tokens[7].type === TokenType.Identifier);
  t.assert(tokens[8].type === TokenType.LineFoldEnd);
  t.assert(tokens[9].type === TokenType.LineFoldStart);
  ...
  t.assert(tokens[13].type === TokenType.Identifier);
  t.assert(tokens[14].type === TokenType.LineFoldEnd);
  t.assert(tokens[15].type === TokenType.BlockEnd);
  t.assert(tokens[17].type === TokenType.BlockEnd);
  t.assert(tokens[18].type === TokenType.LineFoldEnd);
});
